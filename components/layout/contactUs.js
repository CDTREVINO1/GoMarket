  ...
  return (
    <div className="relative bg-white dark:bg-gray-900">
      ...
      <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
        <div className="bg-gray-50 px-6 py-16 dark:bg-gray-800 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
            ...
            <form action="#" method="POST" className="grid grid-cols-1 gap-y-6">
              <div>
                ...
                <input
                  ...
                  id="full-name"
                  autoComplete="name"
                  className="block w-full rounded-md border-gray-300 px-4 py-3 placeholder-gray-500 shadow-sm focus:border-blue-700 focus:ring-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
